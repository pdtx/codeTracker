...
public final class ExceptionMessage {
    private static final String TRACKER_INFO_NULL = " TRACKER_INFO_NULL! ";
    ...
    public static final String PRE_INFO_NULL = " PRE_INFO_NULL! ";
    public static final String CUR_INFO_NULL = " CUR_INFO_NULL! ";
}