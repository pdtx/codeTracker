...
//                    if (trackerInfo == null) {
//                        log.error("FieldInfo info null! commit:{}, filePath:{}, className:{}, name:{}",curRepoInfo.getCommit(), preFieldInfo.getFilePath(), preFieldInfo.getClassName(), preFieldInfo.getSimpleName());
//                        continue;
//                    }
...
//                        if (trackerInfo == null) {
//                            log.error("method trackerInfo null！ commit:{}, class name:{}, signature:{}", curRepoInfo.getCommit(), curMethodInfo.getClassName(), curMethodInfo.getSignature());
//                            continue;
//                        }
//                        curMethodInfo.setTrackerInfo(new TrackerInfo(RelationShip.CHANGE.name(), trackerInfo.getVersion() + 1, trackerInfo.getRootUUID()));
//                        curMethodInfo.getDiff().getJSONArray("data").add(oneDiff);
...
//            boolean isSameFilePath = filePath.contains(methodInfo.getFilePath()) || methodInfo.getFilePath().contains(filePath);
