...
//        restInterface.freeRepo(repoUuid, repoPath.get());
    ...
    private void scan (String repoUuid, String commitId, String branch, JGitHelper jGitHelper, String repoPath) {
        ...
        if (fileMap.keySet().size() > 1) {
            dealWithMerge(jGitHelper,commitId,repoPath,outputPath,repoUuid,branch);
            return;
        }
    ...
    private void dealWithMerge(JGitHelper jGitHelper, String commit, String repoPath, String outputPath, String repoUuid, String branch) {
